...
#define CS_SETOUT() TRISBbits.TRISB14 = 0 
#define CS_LOW()  PORTBbits.RB14 = 0	/* MMC CS = L */
#define CS_HIGH() PORTBbits.RB14 = 1	/* MMC CS = H */
...
#define SOCKPORT	PORTJ		/* Socket contact port */
